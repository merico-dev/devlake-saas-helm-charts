...
{{- define "prometheusalert.appconf.secret" -}}
{{- if .Values.config.appConfSecretName -}}
{{- .Values.config.appConfSecretName -}}
{{- else -}}
{{ include "prometheusalert.fullname" . }}-app-conf-secret
{{- end -}}
{{- end -}}